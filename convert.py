...
def check_type_support(input_file_type, output_file_type)
    ...
    entries = os.listdir(os.path.abspath(./supported_types))
    ...
    for entry in entries:
        ...
        if os.path.isfile(full_path):
            ...
            with open(full_path, 'r') as file:
                type_file = file.read()
                input_types = ast.literal_eval(type_files.splitlines()[1]) # split file into lines, pick line 1 (0-based index) and convert it into a list (from a string representation of one)
                output_types = ast.literal_eval(type_files.splitlines()[1])
                ...
                if input_file_type in input_types and output_file_type in output_types:
                    ...
                    return type_files.splitlines()[0], full_path
        else:
            pass
